from csdigit.csd import to_csd, to_csd_i, to_decimal, to_decimal_using_pow, to_csdnnz, to_csdnnz_i

print("=== to_csd (float) ===")
for v, p in [(28.5,2), (-0.5,2), (0.0,2), (2.5,4), (0.0,0), (7.0,0), (-7.0,0), (28.5,0)]:
    res = to_csd(v, p)
